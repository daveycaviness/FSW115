...
newCar.forEach(function(e, item){
    let newCarList = document.createElement("li");
    newCarList.textContent = `Year: ${newCar[item].year} Make: ${newCar[item].make} Model: ${newCar[item].model} Horsepower: ${newCar[item].horsepower}`;
    let listImg = document.createElement("div");
    let newImg = document.createElement("img");
    newImg.setAttribute("src", `${newCar[item].img_url}`);
    listImg.appendChild(newImg);
    newCarList.appendChild(listImg);  
   
    newList.appendChild(newCarList);
})